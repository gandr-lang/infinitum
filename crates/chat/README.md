...
| Outcome | `ChatOutcome`, `Finish`, `GeneratedToolCall` | Content, reasoning, parsed tool calls, the finish reason, token accounting, phase times and speculative tallies. |
