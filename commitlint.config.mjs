...
//
// One package lives here, so `engine` names its sources and there is no crate
// category axis to spend a scope on. The remaining scopes name the surfaces
// that carry no package.
const SCOPES = ["agents", "ci", "config", "engine", "github", "repo", "review"];
